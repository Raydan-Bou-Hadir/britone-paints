        ...
        <div id='who-we-are' className='about-us-container p-6 md:p-10'>
          ...
          <div className='flex flex-col gap-4 max-w-none '>
            <p className='container-text'>
              ...
              across West Africa. NPI Liberia, the third factory in the region,
              was established in response to strong customer demand for Britone
              Paint—a trusted brand renowned for its lasting quality and
              performance.
            </p>
            <p className='container-text'>
              Our growth has been fueled by the superior quality of our products
              and an unwavering commitment to customer satisfaction. Before
              NPI's establishment in Liberia, Britone Paint had been imported
              into the country for many years. The decision to open a local
              factory was driven by the brand's loyal customer base and their
              encouragement to make Britone more accessible.
            </p>
            <p className='container-text'>
              ...
              European suppliers. Our continued success reflects our dedication
              to quality, innovation, and meeting the evolving needs of our
              customers.
            </p>
          </div>
        </div>
        <div className='about-us-special-container gap-4 p-6 md:p-10'>
          <div className='w-[30%] rounded-full border-4 border-gray-400/50 p-3'>
            <img
              ...
              alt='CEO'
              className='w-full shadow-[0_0_50px_rgba(0,0,0,0.2)] shadow-gray-300 mx-auto rounded-full'
            />
          </div>
          <div className='w-[70%] flex flex-col gap-6'>
            <div className='flex flex-col gap-2 items-start '>
              <i className='text-[#ffffffe2] text-5xl'>
                <RiDoubleQuotesR />
              </i>
              <h3 className='text-white text-3xl font-bold'>Sergio La Torre</h3>
              <div className='flex flex-row items-center gap-1'>
                <span
                  className="relative before:content-[''] before:block 
                                    before:w-8 before:h-[2px] before: bg-dark-red 
                                    before:align-middle mx-1"
                ></span>
                <p className='text-white text-sm'>Chief Executive Officer</p>
              </div>
            </div>
            <div className='px-4 py-2 border-l-[3px] border-[#a10212]'>
              <p className='text-white'>
                "With a legacy built on intelligence, integrity, and passion, I
                lead Britone Paints into the future by honoring its innovative
                past. Under our leadership, Britone continues to grow as a
                dynamic, forward-thinking leader in the paint industry."
              </p>
            </div>
            <div className='flex flex-row justify-between items-center w-full'>
              <span
                className="relative before:content-[''] before:block 
                                ...
                                before:align-middle"
              ></span>
              <p className='text-[#cccacb] text-sm tracking-wider'>
                LEADERSHIP
              </p>
              <span
                className="relative before:content-[''] before:block 
