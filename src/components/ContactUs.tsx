      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_2fr] gap-12 max-w-6xl mx-auto items-stretch">
          ...
          <div className="flex flex-col space-y-6 h-full">
            ...
            <Card className="flex-1">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2 navy-blue">Email</h3>
                    <a
            ...
            <Card className="flex-1">
              <CardContent className="p-8">
                <h3 className="font-semibold text-lg mb-4 navy-blue">Follow Us</h3>
                <div className="flex gap-4">
                  ...
                  >
                    <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer"> <Facebook className="h-5 w-5" /> </a>
                  </Button>
                  ...
                  <Button
                    ...
                    className="rounded-full bg-transparent hover:bg-primary hover:text-white  hover:cursor-pointer"
                  >
                    <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer"> <Instagram className="h-5 w-5" /> </a>
                  </Button>
                  ...
                  <Button
                    ...
                    className="rounded-full bg-transparent hover:bg-primary hover:text-white  hover:cursor-pointer"
                  >
                    <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer"> <Linkedin className="h-5 w-5" /> </a>
                  </Button>
                </div>
              </CardContent>
            </Card>
