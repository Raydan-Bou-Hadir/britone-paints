...
const Home = () => {
  return (
    <section id='home' className='w-full h-screen'>
      <div
        className='relative w-full h-full flex flex-col justify-between px-12 pb-4 bg-cover bg-center'
        style={{
      ...
      >
        ...
        <div className='relative flex flex-col justify-center items-start h-full max-w-3xl gap-6 pl-24'>
          <h1 className='navy-blue text-5xl md:text-6xl lg:text-7xl font-bold text-balance'>
            The Everlasting Tones of Brightness
          </h1>
          <p className='text-xl md:text-2xl text-pretty leading-relaxed text-gray-500'>
