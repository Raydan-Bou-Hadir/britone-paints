...
const Home = () => {
    return (
        <section id="home" className="w-full h-screen">
            <div className="relative w-full h-full flex flex-col justify-between px-12 pb-4 bg-cover bg-center" style={{ backgroundImage: "url('./src/assets/products/hero-paint.jpg')" }}>
