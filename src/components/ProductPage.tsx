...
export default function ProductPage() {
  ...
  const nextProduct =
    productIndex < allProducts.length - 1 ? allProducts[productIndex + 1] : null;
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4 lg:px-8">
          {/* Back Button */}
          <Link to="/" onClick={(e) => { e.preventDefault(); scrollToProducts(); }}>
            <Button variant="outline" className="navy-blue mb-8 bg-transparent cursor-pointer hover:bg-dark-red">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl font-bold mb-4 navy-blue">{product.productName}</h1>
              ...
              <Card>
                <CardContent className="p-6">
                  <h2 className="text-xl font-semibold mb-3 navy-blue">Features</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-lg font-medium navy-blue">{product.productFinish}</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-lg font-medium navy-blue">{product.productColor}</p>
                  </CardContent>
                </Card>
              </div>
            </div>
