...
function Products() {
  ...
  const decorativeProducts = useDecorativeProductsStore(
    (state) => state.productGroup,
  );
  const industrialProducts = useIndustrialProductsStore(
    (state) => state.productGroup,
  );
  ...
  return (
    <section
      id='products'
      className='flex flex-col gap-12 py-24 bg-gradient-to-br from-blue-50 via-white to-red-50'
    >
        ...
        <div className='relative'>
          ...
          <div className='flex flex-col gap-3 lg:w-[65%] rounded-full pl-6'>
            <div className='flex flex-row items-center gap-2'>
              ...
              <h4 className='text-2xl font-bold navy-blue'>
                Decorative Products
              </h4>
            </div>
            <p className='text-[14px] leading-relaxed text-muted-foreground'>
              BRITONE offers a complete range of products in the field of
              decorative paints, which includes water-based paints,
              solvent-based paints and solvent-free coatings. These products are
              used for the inside and outside to decorate and protect the
              surface. The BRITONE paint is used for residential buildings,
              hotels, theaters, restaurants, hospitals, shopping centers, sports
              complexes.
            </p>
          </div>
        </div>
        ...
        <div className='relative'>
          ...
          <div className='flex flex-col gap-3 lg:w-[65%] rounded-full pl-6'>
            <div className='flex flex-row items-center gap-2'>
              ...
              <h4 className='text-2xl font-bold dark-red'>
                Industrial Products
              </h4>
            </div>
            <p className='text-[14px] leading-relaxed text-muted-foreground'>
              The painting BRITONE offers quality solutions to improve, beautify
              and protect your buildings. Our wide range of products is
              specially made for the sole purpose of exercising to cheer you in
              the industry. Our paints are used as high-performance coatings for
              various installations. BRITONE has developed a variety of Products
              for coating applications of all materials.
            </p>
          </div>
        </div>
