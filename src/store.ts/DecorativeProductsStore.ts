...
export const useDecorativeProductsStore = create<ProductStoreState>(() => ({
  productGroup: [
    {
      id: 1,
      ...
      productDescription:
        'A high-quality interior paint that provides excellent coverage and durability.',
      productColor: 'White',
      productFinish: 'Matte',
    ...
    },
    {
      ...
      productDescription:
        'Durable exterior paint designed to withstand harsh weather conditions.',
      productColor: 'Blue',
      productFinish: 'Satin',
    ...
    },
    {
      ...
      productDescription:
        'An environmentally friendly paint option with low environmental impact.',
      productColor: 'Green',
    ...
    },
    {
      ...
      productDescription:
        'A high-gloss enamel paint that provides a shiny, durable finish.',
      productColor: 'Red',
    ...
    },
    {
      ...
      productDescription:
        'A premium wood paint that enhances the natural beauty of wood while providing long-lasting protection.',
      productColor: 'Brown',
      productFinish: 'Satin',
